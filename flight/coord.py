...
def wait_workers(timeout_s: float = 3600.0) -> None:
    ...
    log("on zeno-01: curl -fsSL http://10.87.131.182:8775/flight/start-worker.sh | bash -s zeno-01")
    log("on zeno-03: curl -fsSL http://10.87.131.182:8775/flight/start-worker.sh | bash -s zeno-03")

#!/usr/bin/env python3
"""Tiny HTTP KV for NIXL control-plane metadata (mgmt 1G, not CX-7).

PUT  /k/<key>          store bytes
GET  /k/<key>          wait until present (query wait=seconds, default 180)
DELETE /k/<prefix>     drop keys with this prefix
GET  /health           ok
"""
